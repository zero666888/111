...
export default function VancetWebsite() {
  const holderData = [
    { name: "尤**", contact: "con****@qq.com", amount: "73000" },
    { name: "喻**", contact: "177****39", amount: "71000" },
    ...
    { name: "褚**", contact: "con****@outlook.com", amount: "40000" },
    { name: "水**", contact: "187****31", amount: "40000" },
    { name: "谢**", contact: "use****@gmail.com", amount: "38000" },
    { name: "尤**", contact: "mai****@outlook.com", amount: "37000" },
    { name: "冯**", contact: "con****@outlook.com", amount: "35000" },
    { name: "喻**", contact: "con****@outlook.com", amount: "32000" },
    { name: "陈**", contact: "mai****@outlook.com", amount: "31000" },
    { name: "吴**", contact: "mai****@outlook.com", amount: "31000" },
    { name: "喻**", contact: "134****33", amount: "30000" },
    { name: "吕**", contact: "173****48", amount: "26000" },
    { name: "李**", contact: "153****53", amount: "25000" },
    { name: "朱**", contact: "154****84", amount: "24000" },
    { name: "钱**", contact: "mai****@gmail.com", amount: "22000" },
    { name: "孔**", contact: "con****@gmail.com", amount: "21000" },
    { name: "秦**", contact: "191****85", amount: "21000" },
    { name: "戚**", contact: "mai****@gmail.com", amount: "21000" },
    { name: "朱**", contact: "con****@163.com", amount: "19000" },
    { name: "蒋**", contact: "use****@outlook.com", amount: "19000" },
    { name: "喻**", contact: "159****64", amount: "18000" },
    { name: "褚**", contact: "con****@qq.com", amount: "18000" },
    { name: "杨**", contact: "mai****@outlook.com", amount: "17000" },
    { name: "蒋**", contact: "mai****@163.com", amount: "17000" },
    { name: "郑**", contact: "use****@gmail.com", amount: "17000" },
    { name: "钱**", contact: "use****@outlook.com", amount: "16000" },
    { name: "戚**", contact: "con****@outlook.com", amount: "15000" },
    { name: "吴**", contact: "186****21", amount: "14000" },
    { name: "窦**", contact: "use****@gmail.com", amount: "13000" },
    { name: "许**", contact: "con****@qq.com", amount: "13000" },
    { name: "姜**", contact: "183****55", amount: "12000" },
    { name: "吴**", contact: "152****56", amount: "12000" },
    { name: "冯**", contact: "con****@163.com", amount: "11000" },
    { name: "窦**", contact: "188****11", amount: "11000" },
    { name: "钱**", contact: "152****15", amount: "10000" },
    { name: "施**", contact: "con****@outlook.com", amount: "10000" },
    { name: "水**", contact: "183****61", amount: "10000" },
    { name: "周**", contact: "159****69", amount: "10000" },
    { name: "何**", contact: "136****58", amount: "9000" },
    { name: "秦**", contact: "182****08", amount: "9000" },
    { name: "谢**", contact: "use****@163.com", amount: "8000" },
    { name: "谢**", contact: "use****@qq.com", amount: "8000" },
    { name: "张**", contact: "mai****@163.com", amount: "8000" },
    ...
    { name: "喻**", contact: "con****@163.com", amount: "5000" },
    { name: "赵**", contact: "131****80", amount: "5000" },
    { name: "卫**", contact: "mai****@qq.com", amount: "5000" },
    { name: "褚**", contact: "151****53", amount: "5000" },
    { name: "郑**", contact: "191****30", amount: "3000" },
    { name: "秦**", contact: "mai****@qq.com", amount: "3000" },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      >
        ...
        <div className="relative container mx-auto px-4 py-16 text-center flex flex-col justify-center min-h-[500px]">
          <div className="mb-6">
            <Image
              src="/images/vancet-logo.png"
              alt="VANCET Logo"
              width={120}
              height={120}
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-4 text-white drop-shadow-lg">VANCET</h1>
          <p className="text-xl md:text-2xl text-white drop-shadow-md">VANCE Token Whitepaper</p>
        </div>
      </header>
